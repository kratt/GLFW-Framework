...
{
    for(int attachment=GL_COLOR_ATTACHMENT0; attachment<GL_COLOR_ATTACHMENT0+m_maxColorAtt; ++attachment)
    {
...
{
    int texID = emptyTexture(m_width, m_height, iFormat, format, type);
