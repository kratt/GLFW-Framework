...
GLubyte TgaLoader::uTGAcompare[12] = { 0, 0, 2, 0, 0, 0, 0, 0, 0, 0, 0, 0 };	// Uncompressed TGA Header
GLubyte TgaLoader::cTGAcompare[12] = { 0, 0, 10, 0, 0, 0, 0, 0, 0, 0, 0, 0 };	// Compressed TGA Header
...
/********************************************************************************/
bool TgaLoader::loadTga(Texture & texture, const std::string & filename)				// Load a TGA file
{
	...
	{
		std::cerr << "Could not open texture file" << filename << std::endl;	// Display an error message
...
bool TgaLoader::loadUncompressedTGA(Texture & texture, const std::string & filename, FILE * fTGA)	// Load an uncompressed TGA (note, much of this code is based on NeHe's 
...
bool TgaLoader::loadCompressedTGA(Texture & texture, const std::string & filename, FILE * fTGA)		// Load COMPRESSED TGAs
{
